...
class Sensor:
    ...
    def __contains__(self, pos) -> bool:
        if self.inside: return pos in self.inside
        return (self._in_bounds(pos) and
                manhattan_2d((self.sx, self.sy), pos) < self.man_range)
    ...
    def _in_bounds(self, pos:tuple[int,int]) -> bool:
        return (self._bounds[0]<pos[0]<self._bounds[1] and
                self._bounds[0]<pos[1]<self._bounds[1])
